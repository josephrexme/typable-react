...
const toPropTyped = (propType, required = false, params = null) => {
  ...
  if (required) {
    return PropTypes__default['default'][propType.name](params ?? propType.params).isRequired;
  }

  return PropTypes__default['default'][propType.name](params ?? propType.params);
};
